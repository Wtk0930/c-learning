...
int main()
{
    ...
    my_movies.displayAllMovies();

    my_movies.addMovie("Big", "PG-13", 2); // OK
    my_movies.addMovie("Star Wars", "PG", 5); // OK
    my_movies.addMovie("Cinderella", "PG", 7); // OK

    my_movies.displayAllMovies(); // Big, Star Wars, Cinderella

    my_movies.addMovie("Cinderella", "PG", 7); // Already exists
    my_movies.addMovie("Ice Age", "PG", 12); // OK

    my_movies.displayAllMovies(); // Big, Star Wars, Cinderella, Ice Age

    my_movies.incrementWatched("Big"); // OK
    my_movies.incrementWatched("Ice Age"); // OK

    my_movies.displayAllMovies(); // Big and Ice Age watched count incremented by 1

    my_movies.incrementWatched("XXX"); // XXX not found
